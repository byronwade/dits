...
export const aiDocsNavigation: DocSection[] = [
  {
    ...
    items: [
      ...
      { title: "Why Dits for AI", href: "/ai/docs/why-dits" },
      { title: "Quick Start", href: "/ai/docs/getting-started" },
      { title: "Installation", href: "/ai/docs/installation" },
    ],
  },
  {
    title: "Core Concepts",
    href: "/ai/docs/concepts/addressing",
    items: [
      { title: "Three-Layer Addressing", href: "/ai/docs/concepts/addressing" },
      { title: "Content Addressing", href: "/ai/docs/concepts/content-addressing" },
      { title: "Chunking & Deduplication", href: "/ai/docs/concepts/chunking" },
      { title: "Tensor-Aware Chunking", href: "/ai/docs/concepts/tensor-chunking" },
      { title: "Similarity Dedup", href: "/ai/docs/concepts/similarity" },
      { title: "Derivation & Recompute", href: "/ai/docs/concepts/derivation" },
    ],
  },
  {
    title: "Workflows",
    href: "/ai/docs/workflows/checkpoints",
    items: [
      { title: "Versioning Checkpoints", href: "/ai/docs/workflows/checkpoints" },
      { title: "Versioning Datasets", href: "/ai/docs/workflows/datasets" },
      { title: "Fine-Tunes & Variants", href: "/ai/docs/workflows/variants" },
    ],
  },
  {
    title: "Reference",
    href: "/ai/docs/cli",
    items: [
      { title: "CLI for AI", href: "/ai/docs/cli" },
      { title: "Benchmarks", href: "/ai/benchmarks" },
      { title: "Roadmap", href: "/ai/docs/roadmap" },
      { title: "Engine Docs (shared)", href: "/docs" },
    ],
  },
];
