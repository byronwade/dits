...
export class Chunk {
    ...
    get hash() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_chunk_hash(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    get length() {
        const ret = wasm.__wbg_get_chunk_length(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    get offset() {
        const ret = wasm.__wbg_get_chunk_offset(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * Full BLAKE3 content address as a hex string.
    ...
    set hash(arg0) {
        ...
        wasm.__wbg_set_chunk_hash(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * Length of this chunk in bytes.
     * @param {number} arg0
     */
    set length(arg0) {
        wasm.__wbg_set_chunk_length(this.__wbg_ptr, arg0);
    }
    /**
     * Byte offset of this chunk within the input.
     * @param {number} arg0
     */
    set offset(arg0) {
        wasm.__wbg_set_chunk_offset(this.__wbg_ptr, arg0);
    }
}
 ...
 * @returns {Chunk[]}
 */
export function chunk(data, profile) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.chunk(ptr0, len0, profile);
 ...
 * @returns {string}
 */
export function hash_hex(data) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.hash_hex(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./dits_wasm_bg.js": import0,
    };
}

const ChunkFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_chunk_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('dits_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
