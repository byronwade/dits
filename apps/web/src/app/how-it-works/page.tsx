        ...
        <section className="border-t border-border bg-card">
          <div className="container py-16 text-center">
            ...
            <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
              <Button render={<Link href="/docs/architecture" aria-label="Architecture guide"  prefetch={false} />}>
                Architecture guide
                <ArrowRight data-icon="inline-end" />
              </Button>
              <Button variant="outline" render={<Link href="/docs/roadmap" aria-label="Roadmap and gates"  prefetch={false} />}>
                Roadmap and gates
              </Button>
            </div>
          </div>
