...
export const metadata: Metadata = genMeta({
  title: "Video Features - Dits Version Control for Video Production",
  description: "Dits features optimized for video files and production workflows. Format-aware chunking, keyframe alignment, MP4/MOV support, and video-specific metadata for efficient version control of video assets.",
  canonical: "https://dits.dev/docs/advanced/video",
  keywords: [
...
export default function VideoFeaturesPage() {
  const articleSchema = generateArticleSchema({
    headline: "Video Features - Dits Version Control for Video Production",
    description: "Dits features optimized for video files and production workflows. Format-aware chunking, keyframe alignment, MP4/MOV support, and video-specific metadata.",
    datePublished: "2024-01-01",
    dateModified: new Date().toISOString().split("T")[0],
    author: "Byron Wade",
    section: "Documentation",
    tags: ["video", "video production", "mp4", "video workflow"],
  });

  const videoSchema = generateVideoObjectSchema({
    name: "Dits Video Features Overview",
    description: "Learn how Dits handles video files efficiently with format-aware chunking, keyframe alignment, and video-specific optimizations for video production workflows.",
    thumbnailUrl: "/dits.png",
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "Advanced", url: "/docs/advanced" },
    { name: "Video Features", url: "/docs/advanced/video" },
  ]);
        ...
        <Table className="not-prose my-6">
          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell className="text-success flex items-center gap-2"><Check className="h-4 w-4" /> Full</TableCell>
              <TableCell className="text-success flex items-center gap-2"><Check className="h-4 w-4" /> Tested</TableCell>
            ...
            <TableRow>
              ...
              <TableCell className="text-warning flex items-center gap-2"><AlertTriangle className="h-4 w-4" /> Partial</TableCell>
              <TableCell className="text-warning flex items-center gap-2"><Beaker className="h-4 w-4" /> Testing</TableCell>
